...
-- Selects all rows from Student_Table where FIRST_NAME is exactly 5 characters long and ends with the letter 'a'
SELECT * FROM Student_Table WHERE FIRST_NAME LIKE '____a';
