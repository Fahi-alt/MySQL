...
-- Retrieve all columns from the Student_Table
-- Sort the results by FIRST_NAME in ascending order
-- If multiple rows have the same FIRST_NAME, sort those by MAJOR in descending order
