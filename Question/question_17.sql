...
-- Retrieves details of students who have received scholarships
-- Performs an inner join between Student_Table and Scholarship_Table based on matching student IDs
SELECT s.STUDENT_ID, 
       s.FIRST_NAME, 
       s.LAST_NAME, 
